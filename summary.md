...
| `MG.Prop6.1.Telescoping` | toy-model | **PASS** | 0.019 | Pass: telescoping identity holds, abs_error < 1e-15. |
...
| `P88.Lem4.4.LieAlgAnnihilation_SO4` | numerical | **PASS** | 0.092 | Pass: max_violation=0.000601 < 0.01. |
| `P88.Thm4.2.VanishingRate_eta2log` | numerical | **PASS** | 0.000 | Pass: min_rate=1.84e-15 < 1e-10, confirmed vanishing. |
| `P89.Lem6.1.ExpInequality` | exact | **PASS** | 0.001 | Pass: 0 violations in 10001 points, max_ratio=0.999500. |
...
| `P90.Lem6.4.Superpoly_from_c_over_g2` | bound | **FAIL** | 0.000 | Fail: 6 violations for m=10 in [0.001, 0.3] |
| `P90.Lem8.1.TriangularMixingLock_d4_exact` | exact | **PASS** | 4.195 | Pass: unique W4-invariant scalar at d=4 (symbolic). |
